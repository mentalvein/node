var _ = require("underscore"),
	...
	Strategy = require("passport-mentalvein").Strategy;
...
var API = function( options ){
	...
	passport.use(new Strategy({
		...
		callbackURL: "/auth/mentalvein/callback", // option?
...
API.prototype = {
	...
	auth: function(){
		if( arguments[1] ) {
			return passport.authenticate('mentalvein', arguments[0], arguments[1]);
		} else {
			return passport.authenticate('mentalvein', arguments[0]);
		}
	},
